		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#NotificacionesAutomaticas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"NotificacionesAutomaticas-display": {
								"semanticObject": "NotificacionesAutomaticas",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=profertil.notifconf",
									"url": sap.ui.require.toUrl("profertil/notifconf")
								}
							}
						}
					}
